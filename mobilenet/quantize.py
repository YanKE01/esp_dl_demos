...
if __name__ == "__main__":
    ...
    NUM_OF_BITS = 8
    ESPDL_MODEL_PATH = "models/torch/mobilenet_v2_feature_extractor.espdl"
    CALIB_DIR = "./imagenet"
    ...
    # Remove the classifier (feature extractor mode)
    ...
    # --------------------------------------------
    # Since the classifier is removed, standard ImageNet evaluation (accuracy) is not applicable or will fail.
    # Skipping evaluation for feature extractor.
    ...
    #     verbose=1,
    # )
    print("Quantization complete. Model exported to:", ESPDL_MODEL_PATH)